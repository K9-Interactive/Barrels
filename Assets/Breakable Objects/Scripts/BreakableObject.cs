...
public class BreakableObject:MonoBehaviour{
	...
	public float explosiveForce = 350.0f; 			//How much UnityEngine.Random force applied to each fragment
	public float durability = 0.00001f; 				//How much physical force the object can handle before it breaks
	...
	public Action<BreakableObject> onDestroyed;
